...
to setup-globals
  ...
  set time 0
  set recruitment-rate 0.8
  set natural-death-rate 0.4
...
to new-year
  ...
  ask women with  [xcor = 0 and ycor = 0 ][set shape "person righty"]
  ask men with [xcor = 0 and ycor = 0 ][set shape "person lefty" ]
...
to couple  ;; turtle procedure -- righties only!
  let potential-partner one-of (turtles-at -1 0)
                          with [coupled? = false and shape = "person lefty"]
...
to uncouple  ;; turtle procedure
  ...
  if coupled? = true and (shape = "person righty")
...
to infect  ;; turtle procedure
  if coupled? = true and infected? = true and  known? = false and vaccinated? = false
   ...
   if coupled? = true and infected? = true and  known? = false and vaccinated? = true and vaccine-lenght < 2 and virus-type > 2
    [ if random-float 10 > condom-use or
         random-float 10 > ([condom-use] of partner)
        [ if random-float 100 < infection-chance
            [ ask partner [ set infected? true ] ] ] ]]
   ...
   if coupled? = true and infected? = true and  known? = false and vaccinated? = true and vaccine-lenght < 2 and virus-type = 3
    [ if random-float 10 > condom-use or
         random-float 10 > ([condom-use] of partner)
        [ if random-float 100 < infection-chance
            [ ask partner [ set infected? true ] ] ] ]]
