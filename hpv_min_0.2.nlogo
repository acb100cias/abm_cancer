...
export-world "~/tesis/experiment1_run_"behaviorspace-run-number"png"</final>
  ...
  <experiment name="experiment_1" repetitions="100" runMetricsEveryStep="true">
    ...
    <metric>(count turtles with [vaccinated? = true and infected? = true and virus-type = 0])/ (count turtles)</metric>
    <metric>(count turtles with [vaccinated? = true and infected? = true and virus-type = 1])/ (count turtles)</metric>
    <metric>(count turtles with [vaccinated? = true and infected? = true and virus-type = 2])/ (count turtles)</metric>
    <metric>(count turtles with [vaccinated? = true and infected? = true and virus-type = 3])/ (count turtles)</metric>
  ...
  <experiment name="experiment_3" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2400"/>
    <metric>(count turtles with [known? = true]) / (count turtles)</metric>
  ...
  <experiment name="experiment_2" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2400"/>
    <metric>(count turtles with [known? = true]) / (count turtles)</metric>
